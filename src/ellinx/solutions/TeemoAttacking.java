 ...
 * This poisoned status will last 2 seconds until the end of time point 2. And at time point 4, 
 * Teemo attacks Ashe again, and causes Ashe to be in poisoned status for
 ...
 * However, at the beginning of time point 2, Teemo attacks
 * Ashe again who is already in poisoned status. Since the poisoned status won't
 * add up together, though the second poisoning attack will still work at time
 * point 2, it will stop at the end of time point 3. So you finally need to
 * output 3. 
 * 
 * Note: 
...
public class TeemoAttacking {
	...
	public static void main(String[] args) {
		TeemoAttacking tmp = new TeemoAttacking();
		int[] timeSeries = {1,2};
		int result = tmp.findPoisonedDuration(timeSeries, 2);
