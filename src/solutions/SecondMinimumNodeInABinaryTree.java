...
public class SecondMinimumNodeInABinaryTree {
	public int findSecondMinimumValue(TreeNode root) {
        ...
        if (root.left.val>root.right.val) {
            int other = findSecondMinimumValue(root.right);
            if (other>root.val && other<root.left.val) {
                return other;
            }
            return root.left.val;
        } else if (root.left.val<root.right.val) {
            int other = findSecondMinimumValue(root.left);
            if (other>root.val && other<root.right.val) {
                return other;
            }
