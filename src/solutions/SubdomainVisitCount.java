 ...
 * discussed above, the subdomain "leetcode.com" and "com" will also be visited. 
 ...
 * "mail.com" 900 + 1 = 901 times, "com" 900 + 50 + 1 = 951 times, and "org" 5 times.
 * 
 * Notes:
 * 
...
public class SubdomainVisitCount {
	public List<String> subdomainVisits(String[] cpdomains) {
		...
		for (String k : counter.keySet()) {
			String s = Integer.toString(counter.get(k)) + " " + k;
			ret.add(s);
		}
		return ret;
	}
